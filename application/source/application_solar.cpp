...
void ApplicationSolar::update_planet(node* const Planet, float count)const{
    ...
    //rotation
    glm::fmat4 model_matrix2 = glm::rotate(glm::fmat4{}, (2.0f/(count+1))*float(glfwGetTime()), glm::fvec3{0.0f, 1.0f, 0.0f});
    ...
    if(count==0.0){
      ...
      //scale 
      model_matrix2 = glm::scale(model_matrix2, 0.5f * glm::fvec3{1.0f,1.0f,1.0f});
    }
    //other planets
    else
    {
      //radius
      model_matrix2 = glm::translate(model_matrix2*model_matrix2, (count + 5.0f) * glm::fvec3{0.0f, 0.0f, -1.0f});
...
void ApplicationSolar::render() const {
  ...
  //radius
  model_matrix2 = glm::translate(model_matrix2*model_matrix2, glm::fvec3{0.0f, 4.0f, -1.0f});
  //scale 
